      ...
      <div className="hero bg-base-200 max-w-7xl mx-auto my-6 rounded-lg px-6 xl:px-0">
        <div className="py-10">
          <div className="max-w-4xl">
            ...
            <p className="py-6">
              At GigZoom, we believe that everyone should have the opportunity
              to earn money on their own terms. Whether you’re looking to
              supplement your income, gain experience, or simply enjoy the
              flexibility of working from anywhere, GigZoom is here to help you
              achieve your goals. Who We Are GigZoom is a cutting-edge
          ...
          <div className="max-w-4xl">
            ...
            <ul className="py-6 list-disc ml-5">
              <li>
                ...
                whenever and wherever you want. GigZoom allows you to fit work
          ...
          <div className="max-w-4xl">
            ...
            <p className="py-6">
              ...
              transparent, and supportive. At GigZoom, your success is our
